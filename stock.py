...
API_KEY = "1bc0db9c325f481280365f8a685740c2"  # Teri API Key daal di
...
with col1:
    ticker = st.text_input("Stock Symbol Daalo", value=st.session_state.get('ticker', 'RELIANCE'), 
                          placeholder="RELIANCE, TCS, AAPL, NIFTY, SENSEX", label_visibility="collapsed")
with col2:
